...
func deal_with_database(t *DeliverGoodsForPO)error {
	...
	t_purchase_order.createAt=time.Now().Format("2006-01-02 15:04:05").After((company_time_zone-8) * time.Hour)
...
func get_response(t *DeliverGoodsForPO) (string){
	...
	json_ret:=&Response_json{Error_code:"200",Error_msg:"Goods received successfully at "+time.Now().Format("2006-01-02 15:04:05"),Data:Response_json_data{Goods_receipt_no:goods_receipt_no,Bill_type:t.Data.Purchase_order.Bill_type,Receive_by:received,Company:t.Data.Purchase_order.Company,Receive_at:time.Now().Format("2006-01-02 15:04:05"),Reply_system:2},Reply_time:time.Now().Format("2006-01-02 15:04:05")}
